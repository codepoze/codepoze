        ...
        <div class="card">
            <div class="card-header bg-transparent border-bottom align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('admin.product.add') }}" id="add" class="btn btn-secondary btn-sm">
                        <i class="fa fa-plus"></i>&nbsp;Tambah
                    </a>
                </div>
            </div>
            <div class="card-body">
                <table class="table" id="tabel-product-dt"></table>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-product-dt').DataTable({
            serverSide: true,
            responsive: true,
            processing: true,
            ...
            ajax: "{{ route('admin.product.get_data_dt') }}",
            columns: [{
                    title: 'No.',
                    data: 'DT_RowIndex',
                    class: 'text-center'
